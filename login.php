...
<body>
  ...
  <article class="articulologin">
    ...
    <form id="miFormulario" method="POST" action="http://localhost/Avancedeproyecto/php/login.php">
      <br>
      <label for="correo">Correo electrónico</label>
      <input id="correo" name="correo" placeholder="Escribe tu Correo" type="email">
      <br>
