...
<body>
  ...
  <h1>Comentarios</h1>
  <article id="articulocomentario">
    <form method=post id="COMENTARIOS" action="http://localhost/Avancedeproyecto/adm/comentariosIns.php">
      <div class="comentarios" id="comentarios">
        <label> ¡Compártenos tu opinion! </label>
        <br>
        <br>
        <textarea rows="10" cols="80" class="cajaComentarios" id="cajaComentarios" name=texto></textarea>
        <br>
        <button type="submit" class="botonComentarios" id="botonComentarios">Enviar</button>
      </div>
    </form>
  </article>
